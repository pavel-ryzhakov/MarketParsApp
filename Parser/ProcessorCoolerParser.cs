...
{
    internal class ProcessorCoolerParser
    {
        ...
        public ProcessorCoolerParser(IDbContextFactory<DataBaseContext> contextFactory)
        {
...

        {
            ...
            //            ctx.Refresh();
                        ...
                        foreach (var product in products)
                        {
                            ...
                            ProcessorCooler entity = new ProcessorCooler();
                            ...
                            try
                            {
                                ...
                                entity.Socket = doc.QuerySelector("td#tdsa2118").FirstChild.TextContent;
                                entity.Airflow = doc.QuerySelector("td#tdsa1505").FirstChild.TextContent;
                                entity.Speed = doc.QuerySelector("td#tdsa639").FirstChild.TextContent; 
                                entity.Size = doc.QuerySelector("td#tdsa37650").FirstChild.TextContent;
                                ...
                                //ctx.Refresh();
                                await context.ProcessorCoolers.AddAsync(entity);
                                _count++;
