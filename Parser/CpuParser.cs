...
namespace MarketParsApp.Parser
{
    ...
    internal class CpuParser
    {
        ...
        public CpuParser(DataBaseContext data)
        {
        ...
        public async IAsyncEnumerable<Processor> StartParse(List<string> products)

        {
            ...
            //            ctx.Refresh();
                        ...
                        foreach (var product in products)
                        {
                            ...
                            //List<Processor> dtList = new List<Processor>();
                            ...
                            catch (Exception e)
                            {
                                ...
                                AnsiConsole.WriteLine($"Параметр К-во ядер у {entity.Model} не найден! Код ошибки {e}");
                                
                                continue;

                            }

                            string freq = doc.QuerySelector("td#tdsa3808").FirstChild.TextContent ?? "n/a";
                            ...
                            try
                            {
                                ...
                                entity.Mass = Int32.Parse(Regex.Replace(mass, @"\D+", "", RegexOptions.ECMAScript));
                            }
                            catch (Exception e)
                            {
                                AnsiConsole.WriteLine($"Параметр Масса у {entity.Model} не найден! Код ошибки {e}");
                                continue;
                            }
                            ...
                            {
                                AnsiConsole.WriteLine($"Параметр Цена у {entity.Model} не найден! Код ошибки {e}");
                                continue;
                            }
