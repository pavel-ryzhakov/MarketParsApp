...
{
    internal class SolStateDriveParser
    {
        ...
        public SolStateDriveParser(IDbContextFactory<DataBaseContext> contextFactory)
        {
...

        {
            ...
            //            ctx.Refresh();
                        ...
                        foreach (var product in products)
                        {
                            ...
                            SolStateDrive entity = new SolStateDrive();
                            ...
                            try
                            {
                                ...
                                entity.ReadSpeed = doc.QuerySelector("td#tdsa1396").FirstChild.TextContent;
                                entity.WriteSpeed = doc.QuerySelector("td#tdsa1395").FirstChild.TextContent;
                                ...
                                //ctx.Refresh();
                                await context.SolStateDrives.AddAsync(entity);
                                _count++;
