...
namespace MarketParsApp.Parser
{
    internal class PcCaseParser
    {
        ...
        public PcCaseParser(IDbContextFactory<DataBaseContext> contextFactory)
        {
            ...
            _count = 0;
                        ...
                        foreach (var product in products)
                        {
                            ...
                            try
                            {
                                ...
                                string form = doc.QuerySelector("td#tdsa2510").FirstChild.TextContent;
                                int ind = form.IndexOf("Корпус ");
                                entity.CaseFormat = form.Remove(0, ind + 7).Trim();
                    
                                entity.BoardFormat = doc.QuerySelector("td#tdsa643").FirstChild.TextContent;
                                entity.Color = doc.QuerySelector("td#tdsa578").FirstChild.TextContent;
                                entity.Mass = doc.QuerySelector("td#tdsa727").FirstChild.TextContent;
                                ...
                                string tb3 = entity.CaseFormat;
                                string tb4 = entity.BoardFormat;
                                string tb5 = entity.Color;
                                string tb6 = entity.Mass;
                                ...
                                ctx.Refresh();
                                await context.PcCases.AddAsync(entity);
                                _count++;
