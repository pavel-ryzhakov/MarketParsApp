...
{
    internal class RanAcMemoryParser
    {
        ...
        public RanAcMemoryParser(IDbContextFactory<DataBaseContext> contextFactory)
        {
...

        {
            ...
            //            ctx.Refresh();
                        ...
                        foreach (var product in products)
                        {
                            ...
                            RanAcMemory entity = new RanAcMemory();
                            ...
                            try
                            {
                                ...
                                string type = doc.QuerySelector("td#tdsa2510").FirstChild.TextContent;
                                int ind = type.IndexOf("Модуль памяти ");
                                entity.DdrType = type.Remove(0, ind + 14).Trim();

                                entity.DdrSum =
                                    Int32.Parse(doc.QuerySelector("td#tdsa4273").FirstChild.TextContent);


                                 string sum = doc.QuerySelector("td#tdsa3360").FirstChild.TextContent;
                                entity.MemorySum =
                                    Int32.Parse(Regex.Replace(sum, @"\D+.", "", RegexOptions.ECMAScript));

                                entity.Frequency = doc.QuerySelector("td#tdsa1475").FirstChild.TextContent;
                                ...
                                //ctx.Refresh();
                                await context.RanAcMemories.AddAsync(entity);
                                _count++;
